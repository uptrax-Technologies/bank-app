...
if (isset($_GET['del_id'])) {
  $del = $_GET['del_id'];
  $Delete = "DELETE FROM transaction_history where id = '$del' ";
  $resu = mysqli_query($con, $Delete);
  if ($resu) {
    echo "<script>alert('Transanction Deleted succesully')</script>";
  }
}
?>
				...
				<div class="box pull-up">
					<div class="box-body">
						<div class="row align-items-center">
							...
							<div class="col-6">
								<h4 class="counter text-dark text-center mb-0">INVESTMENTS</h4>
								
							</div>
							<div class="col-3">
								<a href="#" class="btn btn-success btn-sm float-right">1</a>
							</div>
							<div class="col-12">
				...
				<div class="box pull-up">
					<div class="box-body">
						<div class="row align-items-center">
							...
							<div class="col-6">
								<h4 class="counter text-dark text-center mb-0">CAPITAL</h4>
								
							</div>
							<div class="col-3">
								<a href="#" class="btn btn-danger btn-sm float-right">$50,000</a>
							</div>
							<div class="col-12">
				...
				<div class="box pull-up">
					<div class="box-body">
						<div class="row align-items-center">
							...
							<div class="col-6">
								<h4 class="counter text-dark text-center mb-0">TENURE
								</h4>
								
							</div>
							<div class="col-3">
								<a href="#" class="btn btn-success btn-sm float-right">90DAYS</a>
				...
				<div class="box pull-up">
					<div class="box-body">
						<div class="row align-items-center">
							...
							<div class="col-6">
								<h4 class="counter text-dark text-center mb-0">INTEREST</h4>
								
							</div>
							<div class="col-3">
								<a href="#" class="btn btn-danger btn-sm float-right">25%</a>
							</div>
							<div class="col-12">
		...
		<div class="row">
			...
			<div class="box">
                ...
                <th>Status</th>
						  ...
						  <tbody>
                <?php
                          $tquery = "SELECT created_at, transaction_id, amount, account, depositor, description, transaction_type, date FROM transaction_history JOIN fund  ORDER BY created_at DESC LIMIT 10";
                          $rt = mysqli_query($con, $tquery);
              ...
              <td>
                ...
                <!--  <td>
                <time class="timeago" datetime="2018-02-01T13:38:01Z" title="2018-02-01 13:38 GMT"><?php echo $row['Date']; ?></time>
                </td> -->
