					...
					<div class="table-responsive">
						<table class="table table-bordered no-margin">
						  ...
						  <tbody>
							<tbody>
                <?php
                          $tquery = "SELECT transaction_id, amount, account, depositor, description, transaction_type, date FROM transaction_history JOIN fund  ORDER BY transaction_id DESC LIMIT 10";
