			...
			<div class="box">
				...
				<div class="box-body">
                 ...
                 <th>Delete</th>
						  ...
						  <tbody>
							   <?php
                  $loan = "SELECT * FROM loan ORDER BY id DESC";
                  $rl = mysqli_query($con, $loan);
               ...
               <td><?php echo $row['amount']; ?></td>
							  ...
							  <td><?php echo $row['Rep_pay_date']; ?></td>
							  <td><?php echo $row['Interest']; ?></td>
							  <td><?php echo $row['Status']; ?></td>
							  <td><span class="label label-success">Approved</span></td>
							  <td>
							 <a href=""> <span <button type="button" class="btn btn-outline-danger">Delete</button></span></a>
							 </br>
							  </br>
							  <a href=""><span <button type="button" class="btn btn-outline-warning">Edit</button></span></a>
							  </td>
							</tr>
