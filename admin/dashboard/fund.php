...
{
  // get a reference to the amount and the username of the account the funds should be in
  $amount1 = $_POST['amount'];
  $account1 = $_POST['account'];
  
  // query to update the database
  $query = "UPDATE account SET Balance = Balance + '$amount1' WHERE username='$account1'";
  ...
  {
  $sql = $sql . ",upload='$filename1' ";
  }
  $sql = $sql . ",note='$_POST[note]',status='$_POST[status]' WHERE id='$_GET[editid]'";
  ...
  {
    $id = uniqid('', true);
    $sql = "INSERT INTO fund(account, amount, date, description, transaction_type, depositor, address, mobile, uid) values('$_POST[account]','$_POST[amount]','$_POST[date]','$_POST[remark]', 'credit', '$_POST[depositor]', '$_POST[address]', '$_POST[mobile]', '$id')";
    
    if(mysqli_query($con, $sql))
    {
      $get_transaction_sql = "SELECT * FROM fund  WHERE uid='$id'";
      $query = mysqli_query($con, $get_transaction_sql);
      if($query){
        $fund = mysqli_fetch_assoc($query);
        $sql2 = "INSERT INTO transaction_history(transaction_id) VALUES ('$fund[uid]')";
        $transaction_query = mysqli_query($con, $sql2);
    ...
    {
      echo "<script>alert('Account funded successfully..');</script>";
      
      $emailq = "SELECT * From account WHERE username = '".$account1."'";
      $rem = mysqli_query($con,$emailq );
      $er = mysqli_fetch_array($rem);
      $bal = $er['Balance'];
      $email = $er['email'];
      ...
      require_once "PHPMailer/Exception.php";
        ...
        $mail->isHTML(true);
        $mail->Subject = 'TRANSACTION NOTIFICATION - CREDIT ALERT';     
        $mail->Body = 'your account has been credited successully with Amount: '.$_POST['amount'].'<br>
...
if(isset($_GET['editid']))
{
  $sql="SELECT * FROM fund where id='$_GET[editid]'";
  $qsql=mysqli_query($con,$sql);
  $rsrec = mysqli_fetch_array($qsql);
  list($firstname,$lastname)=explode(" ",$rsrec['account_name']);
}
?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
	   ...
	   <li class="">
		 ...
		 <li class="active">
          <a href="fund.php">
            <i class="fa fa-leaf"></i> <span>Fund Account</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="">
          <a href="transactions.php">
            <i class="fa fa-history"></i> <span>View Transactions</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="">
          <a href="codes.php">
            <i class="fa fa-history"></i> <span>Transfer Codes</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="">
          <a href="loan.php">
            <i class="fa fa-history"></i> <span>Loans</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
	...
	<div class="row">
      ...
      <div class="box box-solid bg-dark">
        <div class="box-header with-border">
          <h5 class="box-title">Complete the withdrawal form below to begin a withdrawal process.</h5>
          <h6 class="box-subtitle">Ensure to enter all details correctly as withdrawal cannot be undone.</h6>
			...
			<form action="#" class="tab-wizard vertical wizard-circle" method="POST">
				...
				<section class="bg-hexagons-dark">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="custom-select form-control" id="location2" name="account">
                   ...
                   <?php }?>  
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Amount To Credit :</label>
				...
				<section class="bg-hexagons-dark">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="videoUrl2">Date :</label>
								<input type="date" class="form-control" id="videoUrl2" name="date">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="videoUrl2">Depositor - Email :</label>
								<input type="text" class="form-control" id="videoUrl2" name="depositor">
							</div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="videoUrl2">Depositor - Address :</label>
								<input type="text" class="form-control" id="videoUrl2" name="address">
							</div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="videoUrl2">Depositor - Mobile :</label>
								<input type="text" class="form-control" id="videoUrl2" name="mobile">
							</div>
						</div>
																								
					</div>
					
					<button type="submit" class="btn btn-success btn-lg" name="submit">Credit Account</button>
