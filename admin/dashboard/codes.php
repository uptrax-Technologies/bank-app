...
include("../dbconnection.php");
 if(isset($_POST['code_1'])){
  ...
  $sql = "INSERT INTO authentication (otp1, otp2, transaction_id) VALUES ('$code_1', '$code_2', '$transaction_id')";
	...
	<div class="row">
      ...
      <div class="box box-solid bg-dark">
        <div class="box-header with-border">
          <h5 class="box-title">Create code for transfer process.</h5>
        ...
        <div class="box-body wizard-content">
			<form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="tab-wizard vertical wizard-circle" method="POST">
				<!-- Step 1 -->
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">COT CODE :</label>
                <input type="text" class="form-control" id="jobTitle6" name="code_1" />
              </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">IMF CODE :</label>
                <input type="text" class="form-control" id="jobTitle6"" name="code_2" />
              </div>
            </div>
            
            <div class="col-md-10">
							<div class="form-group">
								<label for="jobTitle6">Transaction id</label>
                <input type="text" class="form-control" id="jobTitle6"" name="transaction_id" />
              </div>
						</div>
						
						<input type="submit" class="btn btn-success btn-lg" value="Create Code" name="submit" />						
					</div>
