...
if(isset($_POST['btnsubmit'])) {
 $name=$_FILES["img"]["name"];
   ...
   Balance,";
    ...
    $sql = $sql . ") values('$_POST[firstname] $_POST[lastname]','$_POST[branch]','$_POST[account_type]','$_POST[account_number]','$_POST[username]','$_POST[password]', '$_POST[dob]', '$_POST[gender]','$_POST[address]','$_POST[country]','$_POST[state]','$_POST[city]','$_POST[pin]','$_POST[mobile]','$_POST[email]','$_POST[open_date]', '$_POST[note]', '$_POST[status]', '1000', '$name')";
    
    
    // $sql = $sql . ",'$_POST[status]')";
    ...
    require_once "PHPMailer/PHPMailer.php";
        ...
        $mail->isHTML(true);
        $mail->Subject = 'ACCOUNT OPENING NOTIFICATION';      
        $mail->Body = 'your account has been created successully with account name: '.$_POST['firstname'].' '.$_POST['lastname'].'<br>
                        account number: '.$_POST['account_number'].''; // account_number
        ...
        <div class="box-body wizard-content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="firstName1" name="firstname"> </div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="firstName1" name="username"> </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="lastName2">Password :</label>
                <input type="text" class="form-control" id="lastName2" name="password"> </div>
            </div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="email" class="form-control" id="emailAddress2" name="email"> </div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="phoneNumber2">Phone Number :</label>
								<input type="tel" class="form-control" id="phoneNumber2" name="mobile"> </div>
						</div>
					</div>
				...
				<section class="bg-hexagons-dark">
					...
					<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="jobTitle6" name="address"> </div>
						</div>
					
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">City :</label>
								<input type="text" class="form-control" id="jobTitle6" name="city"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">State :</label>
								<input type="text" class="form-control" id="jobTitle6" name="state"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Zip/Pin Code :</label>
								<input type="text" class="form-control" id="jobTitle6" name="pin"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Country :</label>
								<input type="text" class="form-control" id="jobTitle6" name="country"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Gender :</label>
								<input type="text" class="form-control" id="jobTitle6" name="gender"> </div>
						</div>
						<div class="col-md-6">
              <div class="form-group">
                <label for="jobTitle6">Date of Birth :</label>
                <input type="date" class="form-control" id="jobTitle6" name="dob"> </div>
            </div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="jobTitle6" name="account_type"> </div>
						</div>

            <div class="col-md-6">
              <div class="form-group">
                <label for="jobTitle6">Account Number :</label>
                <input type="text" class="form-control" id="jobTitle6" name="account_number"> </div>
            </div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Branch :</label>
								<input type="text" class="form-control" id="jobTitle6" name="branch"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Open Date :</label>
								<input type="date" class="form-control" id="jobTitle6" name="open_date"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Note :</label>
								<input type="text" class="form-control" id="jobTitle6" name="note"> </div>
						</div>
					...
					<button type="submit" class="btn btn-primary btn-lg" name="btnsubmit">Add Beneficiary</button>
