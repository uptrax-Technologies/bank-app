	   ...
	   <li class="">
		 ...
		 <li class="">
          <a href="investments.php">
            <i class="fa fa-leaf"></i> <span>My Investments</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="">
          <a href="wallet.php">
            <i class="fa fa-folder-open"></i> <span>My Wallet</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="">
          <a href="withdraw.php">
            <i class="fa fa-reply-all"></i> <span>Make Withdrawals</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="active">
          <a href="deposit.php">
            <i class="fa fa-shopping-bag"></i> <span>Make Deposits</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		 ...
		 <li class="">
          <a href="transactions.php">
            <i class="fa fa-history"></i> <span>My Transactions</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
		...
		<div class="col-lg-4 col-12">
          <div class="box">
            <div class="box-header with-border">
              <h5 class="box-title">Scan image to pay or click on the barcode image for payment wallet ID</h5>
            </div>
            <div class="box-body">
              <!-- sample modal content -->
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel"><span style="color: blue">BTC PAYMENT ADDRESS</span></h4>
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
							</div>
							<div class="modal-body">
								<h4 style="color:red">Overflowing text to show scroll behavior</h4>
								<p>Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</h3>
								<h3 style="color:blue">3FZbgi29cpjq2GjdwV8eyHuJJnkLtktZc5</p>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-info waves-effect" data-dismiss="modal">DEPOSITED</button>
							</div>
						</div>
						<!-- /.modal-content -->
					</div>
				...
				<!-- /.modal -->
              <img src="images/bc.png" alt="default" data-toggle="modal" data-target="#myModal" class="model_img img-fluid" />
            </div>
          </div>
        </div><!-- /.col -->
