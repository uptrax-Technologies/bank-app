...
if(isset($_SESSION["username"])){
  ...
  $check1=mysqli_query($connect, 'select * from account where username="'.$id.'"');
    ...
    $status = 'pending';
    $amount = $_POST['amount'];
    $repayment_date = $_POST['payment-date'];
  
   $loan = "INSERT INTO loan(Account_Name,amount,Status,Rep_pay_date, duration) VALUES('$name','$amount','$status','$repayment_date', '$duration')";
   $result1 = mysqli_query($connect, $loan);
   if($result1){
    echo "<script>alert('Loan Application Successful')</script>";
     //echo "<script>window.open('view_loan.php','_self')</script>";
   }
   else{
     ...
     <div class="col-lg-7 col-12">
      ...
      <div class="box box-solid bg-dark">
        <div class="box-header with-border">
          <h5 class="box-title">Complete the loan request form below to begin a transfer process.</h5>
      ...
      <form action="#" class="tab-wizard vertical wizard-circle" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="custom-select form-control" id="location2" name="account_name">
                  <option value="">Select Account to credit loan</option>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="location2">Select Duration : <a href="beneficiaries.php"><span style="color:red"><small></small></span></a></label>
                <select class="custom-select form-control" id="location2" name="duration">
                  <option value="">Select Loan Duration</option>
                  <option value="1_Months">1 Months</option>
        ...
        <section class="bg-hexagons-dark">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="videoUrl2">Repayment Duration :</label>
                <input type="date" class="form-control" id="videoUrl2" name="duration">
              </div>
            </div>
            ...
            <input type="submit" class="btn btn-success btn-lg" name="submit" value="Request Loan">
