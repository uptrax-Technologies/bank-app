    ...
    <section class="content">
      ...
      <div class="box box-solid bg-dark">
        <div class="box-header with-border">
          <h5 class="box-title">Complete the form below to add a beneficiary.</h5>
        ...
        <div class="box-body wizard-content">
			<form action="#" class="tab-wizard vertical wizard-circle" method="POST">
				<!-- Step 1 -->
				<h4 style="color:red">Personal Info</h4>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="tel" class="form-control" id="phoneNumber2" name="phone_number"> </div>
						</div>
					</div>
				...
				<!-- Step 2 -->
				<p><h4 style="color:red">Bank Info</h4></p>
				
				<section class="bg-hexagons-dark">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Bank Name :</label>
								<input type="text" class="form-control" name="account_name" id="jobTitle6"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Account Number :</label>
								<input type="text" class="form-control" name="account_number" id="jobTitle6"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Bank Address :</label>
								<input type="text" class="form-control" id="jobTitle6" name="bank_address"> </div>
						</div>
						
						<div class="col-md-6">
							<div class="form-group">
								<label for="jobTitle6">Swift Code :</label>
								<input type="text" class="form-control" id="jobTitle6" name="switf_code"> </div>
						</div>
