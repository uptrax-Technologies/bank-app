...
if(isset($_SESSION["username"])){
  ...
  // $otp1 = $_POST['otp1'];
    ...
    //$otp_query=mysqli_query($connect, 'select * from authentication where otp1="'.$otp1.'" and otp2="'.$otp2.'"');
    //if($otp_query) {

    $transaction_id = rand();
   $bef_name = $_POST['account_name2'];
   $account_name1 = $_POST['account_name1'];
    $amount = $_POST['amount'];
    $description = $_POST['remark'];
    $Date = date('d-m-yy');
    $Balance = $Balance-$amount;
    $transaction_type = 'Debit_alert';

    $check1=mysqli_query($connect, 'select * from account where account_name="'.$account_name1.'"');
    $info1=mysqli_fetch_array($check1);
    $receiver_email = $info1['email'];
    $Balance1 = $info1['Balance'];
    $Balance1 = $Balance1+$amount;
    $transaction_type1 = 'credit_alert';

    $transfer = "INSERT INTO transaction_history(transaction_id,Senders_name, Receivers_name,Amount,Description,Transaction_Type, Balance,Date) VALUES('$transaction_id','$account_name1','$bef_name','$amount','$description','$transaction_type','$Balance','$Date')";

    $transfer2 = "INSERT INTO transaction_history(transaction_id,Senders_name, Receivers_name,Amount,Description,Transaction_Type, Balance,Date) VALUES('$transaction_id','$account_name1','$bef_name','$amount','$description','$transaction_type1','$Balance1','$Date')";

    $transfer3 = "UPDATE account SET Balance = '$Balance' WHERE account_name ='$name'";
    $transfer4 = "UPDATE account SET Balance = '$Balance1' WHERE account_name ='$bef_name'";
    $result3= mysqli_query($connect, $transfer3);
    $result4= mysqli_query($connect, $transfer4);

    $result2 = mysqli_query($connect, $transfer2);

    $result1 = mysqli_query($connect, $transfer);
    if($result1) {
     ...
     <div class="col-lg-7 col-12">
      ...
      <div class="box box-solid bg-dark">
        <div class="box-header with-border">
          <h5 class="box-title">Complete the Wwire transfer form below to begin a transfer process.</h5>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="custom-select form-control" id="location2" name="account_name1">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="custom-select form-control" id="location2" name="account_name2">
