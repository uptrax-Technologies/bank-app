		...
		<div class="row">
			...
			<div class="box">
				...
				<div class="box-body">
					<div class="table-responsive">
						<table class="table table-bordered no-margin">
						 ...
						 <tbody>
               <?php
                          $tquery = "SELECT * FROM fund  WHERE account='$username' ORDER BY id DESC";
                          $rt = mysqli_query($connect, $tquery);
                          // print_r(mysqli_fetch_assoc($rt));
              ...
              <tr>
                ...
                <td>
                <time class="timeago" datetime="2018-02-01T13:38:01Z" title="2018-02-01 13:38 GMT"><?php echo $row['account']; ?></time>
                </td>
                
                <td><?php echo $row['description']; ?></td>
                
                <td><span class="label label-success"><?php echo $row['transaction_type']; ?></span></td>
