				...
				<div class="box-body">
					<div class="table-responsive">
						<table class="table table-bordered no-margin">
						  ...
						  <tbody>
							 <?php
                          $tquery = "SELECT * FROM fund WHERE `depositor`='$email' ORDER BY id DESC LIMIT 10";
                          ...
                          ?>
							<tr>
							  ...
							  <td>
								<time class="timeago" datetime="2018-02-01T13:38:01Z" title="2018-02-01 13:38 GMT"><?php echo $row['depositor']; ?></time>
							  </td>
