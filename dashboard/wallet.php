            ...
            <div class="box box-body bg-hexagons-dark pull-up">
              <div class="media align-items-center p-0">
                <div class="text-center">
				  <a href="#"><i class="fa fa-money" title="XRP"></i></a>
			  	</div>
			  	<div>
				  <h3 class="no-margin text-bold">My Wallet Balance</h3>
				  <span>Withdrawable</span>
			  	</div>
              </div>
              <div class="flexbox align-items-center mt-25">
                <div>
				  <p class="no-margin font-weight-700"><span class="text-yellow">$25.000</span> / $30.000</p>
				  <p class="no-margin"></p>
			  	</div>
			  	<div class="text-right">
				  <p class="no-margin font-weight-600"><span class="text-yellow">84%</span></p>
